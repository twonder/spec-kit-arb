...
- Use the `/arb.` command prefix to easily discover Spec Kit-related commands.
...
- All command files now prefixed with `arb.` (e.g., `arb.specify.md`, `arb.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
