...
**Note**: This template is filled in by the `/arb.plan` command. See `.specify/templates/commands/plan.md` for the execution workflow.
...
```text
specs/[###-feature]/
├── plan.md              # This file (/arb.plan command output)
